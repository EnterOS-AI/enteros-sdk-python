...
type WorkspaceTemplate struct {
	...
	// Models: Top-level `models[]` — the authoritative servability list for templates that publish model choices outside `runtime_config.models`. The registry projection is a subset of this.
